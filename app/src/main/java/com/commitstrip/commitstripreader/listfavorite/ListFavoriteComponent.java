 ...
 */
@FragmentScoped
@Component(dependencies = StripRepositoryComponent.class, modules = ListFavoritePresenterModule.class)
public interface ListFavoriteComponent {

    void inject(ListFavoriteActivity activity);
}